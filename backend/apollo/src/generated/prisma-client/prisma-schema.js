...
input ApplicationCreateInput {
  ...
  specialAccomodations: ApplicationCreatespecialAccomodationsInput
  shirtSize: String
  needTravel: Boolean
  emailOptIn: Boolean
  acceptCodeOfConduct: Boolean
...
input ApplicationCreatespecialAccomodationsInput {
  set: [String!]
}
...
input ApplicationUpdateDataInput {
  ...
  specialAccomodations: ApplicationUpdatespecialAccomodationsInput
  shirtSize: String
  needTravel: Boolean
  emailOptIn: Boolean
  acceptCodeOfConduct: Boolean
...
input ApplicationUpdatespecialAccomodationsInput {
  set: [String!]
}
